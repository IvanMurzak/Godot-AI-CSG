...
namespace com.IvanMurzak.Godot.MCP.CSG
{
    public partial class Tool_CSG
    {
        ...
        public const string EditorInfoToolId = "csg-editor-info";
        ...
        /// csg-editor-info</c>), NOT by the pure-managed unit tests — a plain xUnit host
        ...
        (
            EditorInfoToolId,
            Title = "CSG Tools / Editor Info",
            ReadOnlyHint = true,
            IdempotentHint = true,
            OpenWorldHint = false
        )]
        [Description("Sample editor-only tool for the CSG Tools extension. Returns the running " +
