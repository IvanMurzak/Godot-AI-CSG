...
{
    /// <summary>
    /// Sample MCP tool family for the CSG Tools extension (tool ids prefixed
    /// <c>csg-*</c>). A tool family is one <c>[AiToolType]</c> <c>partial class</c>;
    ...
    ///     live behind <c>#if TOOLS</c> (see <c>../../Editor/Tools/Tool_CSG.EditorInfo.cs</c>),
