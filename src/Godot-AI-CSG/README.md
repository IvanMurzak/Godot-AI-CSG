...
| Tool | Description |
| --- | --- |
| `csg-echo` | Pure-managed readiness probe — echoes a message. |
| `csg-editor-info` | Editor-only — returns the running Godot editor version + UI scale. |
