...
namespace com.IvanMurzak.Godot.MCP.CSG.Tests
{
    ...
    /// PURE-MANAGED sample tool <c>csg-echo</c> by constructing the tool family and
    ...
    /// </summary>
    public class Tool_CSG_EchoTests
    {
        [Fact]
        ...
        {
            var tool = new Tool_CSG();
            Assert.Equal("csg-ready", tool.Echo(message));
        }
        ...
        public void EchoToolId_IsStable()
        {
            ...
            Assert.Equal("csg-echo", Tool_CSG.EchoToolId);
        }
    }
}
